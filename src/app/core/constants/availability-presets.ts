...
export const AVAILABILITY_PRESETS: AvailabilityPreset[] = [
  {
    name: 'full-time',
    value: [
      { day: 'monday', intervals: [{ start: '09:00', end: '17:00' }] },
      { day: 'tuesday', intervals: [{ start: '09:00', end: '17:00' }] },
      { day: 'wednesday', intervals: [{ start: '09:00', end: '17:00' }] },
      { day: 'thursday', intervals: [{ start: '09:00', end: '17:00' }] },
      { day: 'friday', intervals: [{ start: '09:00', end: '17:00' }] },
       { day: 'saturday', intervals: [{ start: '09:00', end: '17:00' }] },
    ],
  },
  {
  ...
  },
  {
    ...
    value: [
      { day: 'monday', intervals: [{ start: '17:00', end: '20:00' }] },
      { day: 'tuesday', intervals: [{ start: '17:00', end: '20:00' }] },
      { day: 'wednesday', intervals: [{ start: '17:00', end: '20:00' }] },
      { day: 'thursday', intervals: [{ start: '17:00', end: '20:00' }] },
      { day: 'friday', intervals: [{ start: '17:00', end: '20:00' }] },
    ],
  },
  {
    name: 'part-time-morning',
    value: [
      { day: 'monday', intervals: [{ start: '09:00', end: '12:00' }] },
      { day: 'wednesday', intervals: [{ start: '09:00', end: '12:00' }] },
      { day: 'friday', intervals: [{ start: '09:00', end: '12:00' }] },
    ],
  },
  {
  ...
  },
  {
    ...
    value: [
      { day: 'tuesday', intervals: [{ start: '17:00', end: '18:00' }] },
      { day: 'thursday', intervals: [{ start: '17:00', end: '18:00' }] },
    ],
  },
];
