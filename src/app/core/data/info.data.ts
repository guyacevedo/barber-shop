...
export const INFO_PAGES_DATA: InfoPage[] = [
  ...
  },
  {
    ...
    content: `
      <p class="mb-4 text-pretty">El mayor activo de BarberApp es, sin duda, nuestro <strong>capital humano</strong>. El equipo está compuesto por barberos y personal administrativo con una amplia y reconocida trayectoria, pero sobre todo, con una <strong>profunda vocación de servicio y cuidado al cliente</strong>.</p>
  ...
  },
  {
    ...
    content: `
      <p class="mb-4 text-pretty">En BarberApp, en cumplimiento con la Ley de Protección de Datos Personales, nos comprometemos a <strong>proteger la privacidad y la confidencialidad de la información</strong> de nuestros clientes. Esta política detalla cómo recopilamos, usamos y protegemos su información.</p>
  ...
  },
  {
    ...
    content: `
      <p class="mb-4 text-pretty">Al utilizar los servicios de la barbería BarberApp y su sitio web, usted <strong>acepta y se compromete a cumplir los siguientes términos y condiciones</strong>. Le rogamos que los lea con atención.</p>
      ...
      <p class="mb-4 text-pretty">BarberApp no se hace responsable del uso indebido de la información presentada en el sitio o de las consecuencias de decisiones tomadas sin la supervisión de un profesional. La <strong>responsabilidad final del diagnóstico y tratamiento recae exclusivamente en el profesional</strong> que atiende al cliente.</p>
