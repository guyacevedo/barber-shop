...
import { Client, Specialist, Specialty, UserBase } from '../../../../core/models';
...
export class UserEditFormComponent implements OnInit {
  ...
  async onSubmit(): Promise<void> {
    ...
    try {
      const updatedData: Partial<Client | Specialist> & { id: string } = { ...this.form.value, id: this.user()?.id };
  ...
  changedValues(): boolean {
    ...
    return !(baseCheck && specialistCheck);
  }
